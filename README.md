...
感谢以下同学提供样本：@horseant @gogoduan @十月 @祈。 [@UNIDY2002](https://github.com/UNIDY2002)
...
- 写 [WakeUp 导入程序](https://github.com/YZune/CourseAdapter/blob/master/src/main/java/parser/THUParser.kt)时顺便改写导入流程
  - 改进普通课程解析逻辑，确保缺少教师信息、遇到体育课、无地点时均能准确解析
  - 确保课程无链接时能正确解析
  - 重写二级课程解析逻辑，完善解析准确度
  - 确保二级课程能正确获取教师信息
  - 重写了合并课程的逻辑，完善合并准确度
- 增加 2021 年春季学期[调课信息](https://thuhole.com/##223029)，实现自动调课
  - 自动调课后，在其他周次会出现灰色的非本周课程，可以在设置里关闭显示
- 由于小爱课程表不支持自定义时间，实验课程无法调整精确时间；无法导入北大课程
